...
def data_processing():
    print('Data Loading...')
    data_train = h5py.File('input_coeff/new_coeff_real_channel_21_eoa_scale_180.mat', 'r')#Channel_set
    data_condition = h5py.File('input_coeff/new_coeff_rx_position_21.mat','r')
    ...
    data_condition = data_condition[:21,:]*31
...
def l2_reg(net_src, net_tgt):
    params_src = net_src.trainable_variables
    params_tgt = net_tgt.trainable_variables
    #params_src
    loss = 0
    for p_src, p_tgt in zip(params_src, params_tgt):
        loss += tf.reduce_sum(keras.losses.mse(p_tgt, p_src))
    return loss
       ...
       # print(real_channel)
        ...
        for i in range(self.d_steps):
            ...
            with tf.GradientTape() as tape:
                ...
                reg = l2_reg(self.discriminator, self.sourceD)*self.regD
                d_loss = d_cost + gp*self.gp_weight+reg
        ...
        with tf.GradientTape() as tape:
            ...
            reg = l2_reg(self.generator, self.sourceG)*self.regG
            g_loss = self.g_loss_fn(gen_img_logits)+reg
  ...
  def on_epoch_end(self, epoch, logs={}):
    if( epoch % 1000 == 0):
      ...
      #self.model.stop_training = True
        self.model.generator.save(os.path.join('epoch/', 'real_21_1000e_epoch_{}_gloss_{}_eoa.h'.format(epoch,logs['g_loss'])))
        self.model.discriminator.save(os.path.join('epoch/', 'real_21_1000e_epoch_discriminator_epoch_{}_dloss_{}_eoa.h'.format(epoch,logs['d_loss'])))
...
g_model = Generator()
#g_model = tf.keras.models.load_model('/root/hzd/pdp_model/model/d1_10000e_epoch_9000_generator_scale_180.h')
g_model = tf.keras.models.load_model('/home/pdp_model/d1_coeff_generator_10000e_tgan_pdap_latent=128_r_scale_180_twc_eoa2.h')
g_model.summary()
#g_model_source = tf.keras.models.load_model('/root/hzd/pdp_model/model/d1_10000e_epoch_9000_generator_scale_180.h')
g_model_source = tf.keras.models.load_model('/home/pdp_model/d1_coeff_generator_10000e_tgan_pdap_latent=128_r_scale_180_twc_eoa2.h')


d_model = Discriminator()
#d_model = tf.keras.models.load_model('/root/hzd/pdp_model/model/d1_10000e_epoch_discriminator_epoch_9000_scale_180.h')
d_model = tf.keras.models.load_model('/home/pdp_model/d1_coeff_discriminator_10000e_tgan_pdap_r_scale_180_twc_eoa2.h')
d_model.summary()
#d_model_source = tf.keras.models.load_model('/root/hzd/pdp_model/model/d1_10000e_epoch_discriminator_epoch_9000_scale_180.h')
d_model_source = tf.keras.models.load_model('/home/pdp_model/d1_coeff_discriminator_10000e_tgan_pdap_r_scale_180_twc_eoa2.h')
channel,condition = data_processing()
...
generator_optimizer = keras.optimizers.SGD(learning_rate=0.0001)
discriminator_optimizer = keras.optimizers.Adam(learning_rate=0.0001)


wgan = WGAN(discriminator=d_model,generator=g_model,sourceD=d_model_source,sourceG=g_model_source,latent_dim=latent,discriminator_extra_steps=2,)
...
wgan.generator.save('d1_real_21_coeff_generator_10000e_tgan_l2norm_scale180_twc_eoa2_01.h')
wgan.discriminator.save('d1_real_21_coeff_discriminator_10000e_tgan_l2norm_scale_180_twc_eoa2_01.h')
...
io.savemat('d1_real_21_loss_10000e_l2norm_scale_180_twc_eoa2_01.mat',mdict={'epoch':epochs,'d_loss':history.history['d_loss'],'g_loss':history.history['g_loss']})
...
plt.legend()
plt.savefig('d1_loss_real_21.jpg')
"""
#wgan.discriminator.save('d1_real_21_coeff_discriminator_10000e_tgan.h')
